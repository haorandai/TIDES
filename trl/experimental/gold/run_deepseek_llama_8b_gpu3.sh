...
# GOLD training launcher for DeepSeek-R1-Distill-Llama-8B.
...
TEACHER_MODEL="deepseek-ai/DeepSeek-R1-Distill-Llama-8B"
OUTPUT_DIR="checkpoints/r1-llama-8b-gold-moredata"
RUN_NAME="deepseek-r1-llama-8b-gold-moredata"

VECTORS_DIR="${VECTORS_DIR:-${PROJECT_ROOT}/vectors_mlp/deepseek-r1-distill-llama-8b}"
